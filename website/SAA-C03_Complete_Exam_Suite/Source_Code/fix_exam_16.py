...
# Get remaining questions for exam 16
exam_16_questions = complete_questions[15 * 65:16 * 65]

# If not enough, fill with first questions
while len(exam_16_questions) < 65:
    exam_16_questions.append(complete_questions[len(exam_16_questions)])

exam_16_questions = exam_16_questions[:65]

# Create the HTML content (same as fix_layout.py)
html_content = f'''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>AWS SAA-C03 Associate Practice Exam 16</title>
...
<body>
    <div class="exam-container">
        <div class="header">
            <h1>AWS SAA-C03 Associate Practice Exam 16</h1>
    ...
    <script>
        window.examQuestions = {json.dumps(exam_16_questions, ensure_ascii=False)};
        
        // Same JavaScript as other fixed exams...
        class SimpleExam {{
...
# Write the fixed exam 16
with open('/Users/Matthieu/Downloads/SolutionsArchitectPracticeExam/SAA-C03_Exam/SAA-C03_Complete_Exam_Suite/Professional_Exams/SAA-C03_Professional_Exam_16_20251110_090831.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print("✅ Fixed: SAA-C03_Professional_Exam_16_20251110_090831.html")
